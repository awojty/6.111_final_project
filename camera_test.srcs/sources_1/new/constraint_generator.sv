...
module constraint_generator(   
                    ...
                    input wire [39:0] image_in1 ,
                    input wire [39:0] image_in2 ,
                    input wire [39:0] image_in3 ,
                    input wire [39:0] image_in4 ,
...
//    logic [39:0] row_constraint_storage [29:0];
    ...
    always_ff @(posedge clk_in) begin
        if(reset_in) begin
            ...
            end else if (process_rows && ~save_constraint  && ~buffer) begin
