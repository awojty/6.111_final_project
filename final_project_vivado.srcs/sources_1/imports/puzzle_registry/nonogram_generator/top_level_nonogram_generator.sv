...
//    reg [11:0] rgb; 
    ...
    assign pixel_out = sw[2]&&((hcount<640) &&  (vcount<480))?frame_buff_out:~sw[2]&&((hcount<320) &&  (vcount<240))?frame_buff_out:12'h111;
    
                                            
    camera_read_test  my_camera(
                           .p_clock_in(pclk_in), // these odd things are directly taken from teh camera jb.ja stuff
                          .vsync_in(vsync_in),
                          .href_in(href_in),
