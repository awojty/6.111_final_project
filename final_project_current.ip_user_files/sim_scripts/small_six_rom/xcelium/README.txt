...
#
# Generated by export_simulation on Wed Dec 01 12:16:15 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './small_six_rom.sh' script.

./small_six_rom.sh -reset_run
...
./small_six_rom.sh -noclean_files

For more information on the script, please type './small_six_rom.sh -help'.
