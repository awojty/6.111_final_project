...
#
# Generated by export_simulation on Wed Dec 01 12:28:51 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './assignments_rom.sh' script.

./assignments_rom.sh -reset_run
...
./assignments_rom.sh -noclean_files

For more information on the script, please type './assignments_rom.sh -help'.
