...
HD_PWD='C:/Users/jules/Documents/nonogram_solver/final_project_current.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_fresher.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_fresher.tcl -notrace
