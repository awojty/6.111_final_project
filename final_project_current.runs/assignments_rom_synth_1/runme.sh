...
HD_PWD='C:/Users/jules/Documents/nonogram_solver/final_project_current.runs/assignments_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log assignments_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source assignments_rom.tcl
