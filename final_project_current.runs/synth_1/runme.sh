...
HD_PWD='C:/Users/jules/Documents/nonogram_solver/final_project_current.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_fresher.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_fresher.tcl
